...
public class MRadioButton extends com.codename1.ui.RadioButton implements MaterialComponent {
	 ...
	 */
	public MRadioButton(com.codename1.ui.Image icon) {
	}
	 ...
	 *  @param icon icon to show next to the button
	 */
	public MRadioButton(String text, com.codename1.ui.Image icon) {
	}
